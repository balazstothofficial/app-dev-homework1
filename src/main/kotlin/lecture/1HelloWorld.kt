...
/**
 * `lecture.main` functions are the program entry points.
 * You can have one per file.
 * In IntelliJ you can start a program by clicking on the green arrow next to a lecture.main function.
 *
 * Tasks:
 * - Create a `lecture.main` function.
 * - Print "Hello World!".
